...
export default function Product() {
  ...
  // When change param filter
  const handlePaginationChange = (e, value) => {
    const searchPagi = new URLSearchParams(location.search);
    searchPagi.set("page", value);
    console.log(searchPagi, value)
    const query = searchPagi.toString();
